...
# Add the backend folder to sys.path to allow absolute imports
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Load dotenv to read DATABASE_URL from .env
load_dotenv()
DATABASE_URL = os.getenv("DATABASE_URL")

# Import Base and models so Alembic is aware of them
...
from app.advocate.client_management.models import Client, ClientDocument, Case, Hearing, Activity, Document
